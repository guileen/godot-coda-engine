# CODA documentation / CODA 文档

Start with the language and a familiar gameplay situation, not implementation terminology. Choose a language before opening a guide. The two language trees are kept separate so each version can be reviewed and extended independently.

先从语言和熟悉的游戏场景开始，而不是实现术语。阅读指南前请选择语言。两套语言目录彼此分开，便于独立审阅，也便于今后扩展更多语言。

| Topic / 主题 | English | 简体中文 |
| --- | --- | --- |
| Meet CODA / 认识 CODA | [English](en/5-minutes-coda.md) | [中文](zh-CN/5-minutes-coda.md) |
| First flow / 第一个流程 | [English](en/first-game-flow.md) | [中文](zh-CN/first-game-flow.md) |
| Language reference / 语法小抄 | [English](en/language.md) | [中文](zh-CN/language.md) |
| Quick start / 快速开始 | [English](en/quick-start.md) | [中文](zh-CN/quick-start.md) |
| Core concepts / 核心概念 | [English](en/concepts.md) | [中文](zh-CN/concepts.md) |
| Compatibility / 兼容性 | [English](en/compatibility.md) | [中文](zh-CN/compatibility.md) |
...
共享界面文案以及新增语言的规则位于 [`i18n/`](../i18n/README.md)。根目录的 GitHub 政策文件是同一公开项目的双语入口。
