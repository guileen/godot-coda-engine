...
The first command points out an unclear flow. The second writes generated GDScript and a source map under `.coda/generated/`. The generated files are output, not files to edit by hand.
